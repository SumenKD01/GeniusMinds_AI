			...
			>
				<View style={styles.HomeContent}>
					<Animatable.Image
						...
						duration={10000}
						iterationCount={1}
						source={require('../../assets/icons/ellipseBack.png')}
						style={{
							right: -150,
							top: '20%',
							width: 400,
					...
					>
						<View style={{ flex: 5, gap: -10 }}>
							<Image
								source={require('../../assets/icons/frame4.png')}
								style={{
									position: 'absolute',
									width: '100%',
									height: 150,
							...
							<Image
								source={require('../../assets/icons/frame7.png')}
								style={{
									position: 'absolute',
									height: 35,
									width: '100%',
						...
						<View style={{ flex: 6, gap: 16 }}>
							<View style={{ gap: -10, paddingTop: 10 }}>
								<Image
									source={require('../../assets/icons/frame5.png')}
									style={{
										position: 'absolute',
										flex: 1,
										height: 70,
								...
								<Image
									source={require('../../assets/icons/frame8.png')}
									style={{
										position: 'absolute',
										height: 30,
										borderRadius: 20,
							...
							<View style={{ gap: -10, paddingTop: 10 }}>
								...
								<Image
									source={require('../../assets/icons/frame9.png')}
									style={{
										position: 'absolute',
										height: 30,
										width: '100%',
					...
					<TouchableOpacity
						onPress={() => router.push({ pathname: '/(tabs)/report' })}
						style={{ width: '100%', marginTop: 20 }}
					>
						<LinearGradient
							colors={['#30D2F6', 'rgb(52, 170, 113)']}
							start={{ x: 1, y: 1 }}
							end={{ x: 0, y: 0 }}
							style={{
								flexDirection: 'row',
							...
							<View>
								<Text
									style={{
										color: 'white',
										fontSize: 16,
										fontFamily: Fonts.SignikaNegative_SemiBold,
									}}
								>
									Violation Report
								</Text>
								<Text
									style={{
										...
										fontSize: 12,
										opacity: 0.5,
										fontFamily: Fonts.SignikaNegative_Regular,
									}}
								>
					...
					>
						<Text
							style={{ color: 'white', fontFamily: 'Poppins', fontSize: 20 }}
						>
							Recent Violations
						</Text>
						<Image
					...
					<FlatList
						...
						renderItem={(item, index = count) => {
							...
							return (
								<TouchableOpacity onPress={() => showImage(item.item)}>
									<Image
									...
									<Text
										style={{
											...
											bottom: 40,
											fontSize: 12,
											fontFamily: Fonts.SignikaNegative_Medium,
											width: '100%',
					...
					>
						...
						<Image
							source={{
								uri: recentInspectionData[imageIndex].Photo
									? recentInspectionData[imageIndex].Photo
						...
						>
							...
							>
								{recentInspectionData[imageIndex].Inspection_No}
							</Text>
							<Text
								style={{
									fontFamily: Fonts.SignikaNegative_Medium,
							...
							>
								{recentInspectionData[imageIndex].Result}
							</Text>
							<Text
								style={{
									fontFamily: Fonts.SignikaNegative_Medium,
							...
							>
								{recentInspectionData[imageIndex].Stage}
							</Text>
							<Text
								style={{
									fontFamily: Fonts.SignikaNegative_Medium,
							...
							>
								{recentInspectionData[imageIndex].Supervisor}
							</Text>
							<Text
								style={{
									fontFamily: Fonts.SignikaNegative_Medium,
							...
							>
								{recentInspectionData[imageIndex]['Time_&_Date']}
							</Text>
						</View>
						<View>
								...
								>
									{imageIndex > 0 && (
										<TouchableOpacity
											...
											style={{ padding: 10, bottom: 75 }}
										>
											<Image
												source={require('../../assets/icons/BackTo.png')}
